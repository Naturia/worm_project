    ...
    while running:
        ...
        if button_clicked_img6 == False:
            ...
            for i in range(len(lateral_locations)-1):
                ...
                #188,143,143
                #192,192,192
                pygame.draw.polygon(screen, (160,160,160),[(lateral_locations[i][0][0], lateral_locations[i][0][1]), (lateral_locations[i+1][1][0], lateral_locations[i+1][1][1]),
                                    (lateral_locations[i+1][1][0], lateral_locations[i+1][1][1]), (lateral_locations[i][1][0], lateral_locations[i][1][1])], 0)
            ...
            for i in range(len(rods_locations)): #cut
                ...
                if i>=2 and i % 5==0:
                    ...
                    pygame.draw.ellipse(screen, (153,50,204),[rods_locations[i][0][0] - 1, rods_locations[i][0][1] +1, 10, 5], 0)
                    #pygame.draw.aaline(screen,(255, 215, 0),location[0],location[1], 2)
                    pygame.draw.ellipse(screen, (240,128,128),[rods_locations[i][0][0] - 1, rods_locations[i][0][1] + 10, 10, 5], 0)
                if i>=2 and i % 3==0:
                    pygame.draw.aaline(screen, (188, 210, 230), rods_locations[i][0], rods_locations[i][1], 2)
                if i>=2 and i%20==0:
                    pygame.draw.ellipse(screen, (255,215,0),[rods_locations[i][0][0] - 1, rods_locations[i][0][1] +5, 10, 5], 0)
                if i>=2 and i%25==0:
                    pygame.draw.ellipse(screen, (255,215,0),[rods_locations[i][0][0] + 5, rods_locations[i][0][1] +5, 10, 5], 0)
                if i>=2 and i<6:
                    pygame.draw.ellipse(screen, (222,184,135),[rods_locations[i][0][0], rods_locations[i][0][1] + 5, 10,5], 0)
                    pygame.draw.ellipse(screen, (222, 184, 135),[rods_locations[i][0][0], rods_locations[i][0][1] + 7, 10, 5], 0)
                    pygame.draw.ellipse(screen, (222, 184, 135),[rods_locations[i][0][0], rods_locations[i][0][1] + 9, 10, 5], 0)
            ...
            for i in range(len(lateral_locations)):
                if i%2==0:
                    ...
                    if i <= 6:
                        pygame.draw.aaline(screen, (106,90,205), (lateral_locations[i][0][0], lateral_locations[i][0][1]),(lateral_locations[i][1][0], lateral_locations[i][1][1]), 2)
                    else:
                        pygame.draw.aaline(screen, (106, 90, 205),(lateral_locations[i][0][0], lateral_locations[i][0][1] + 10),(lateral_locations[i][1][0], lateral_locations[i][1][1] + 10), 2)
                else:
                    pygame.draw.aaline(screen, (153, 50, 204), lateral_locations[i][0], lateral_locations[i][1], 5)
                    if i<=6:
                        pygame.draw.aaline(screen, (95, 158, 160),(lateral_locations[i][0][0], lateral_locations[i][0][1]),(lateral_locations[i][1][0], lateral_locations[i][1][1]), 2)
                    else:
                        pygame.draw.aaline(screen, (95,158,160),(lateral_locations[i][0][0], lateral_locations[i][0][1]-10),(lateral_locations[i][1][0], lateral_locations[i][1][1]-10), 2)
                # pygame.draw.aaline(screen, (255, 215, 0), (location[0][0],location[0][1]+5), (location[1][0],location[1][1]+5), 2)
                # pygame.draw.aaline(screen, (173,255,47), (location[0][0], location[0][1] + 10), (location[1][0], location[1][1] + 10), 2)
                # print("location[0],location[1]",location[0],location[1])
            for location in diagonal_locations: #diagonal
        ...
        if button_clicked_img2 == True:
            ...
            pygame.draw.rect(screen,(0, 255, 0),pygame.Rect(top_left[0],top_left[1],bottom_right[0]-top_left[0],bottom_right[1]-top_left[1]),3)
        ...
        if button_clicked_img3 == True and (xy_pos[0] * scale + shift[0]>310 and xy_pos[1] * scale + shift[1]>100):
            pygame.draw.circle(screen, (Hex_to_RGB(colors[5])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 100)
            pygame.draw.circle(screen, (Hex_to_RGB(colors[4])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 60)
            pygame.draw.circle(screen, (Hex_to_RGB(colors[3])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 35)
            pygame.draw.circle(screen, (Hex_to_RGB(colors[2])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 20)
            pygame.draw.circle(screen, (Hex_to_RGB(colors[1])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 10)
            pygame.draw.circle(screen, (Hex_to_RGB(colors[0])), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]), r + 5)
...
if __name__ == '__main__':
    ...
    worm_net = WormNet(step_size=step_size*ms,worm_entity=worm, nacl_entity = nacl, touch_entity=touch_signal,
                    ...
                    tail_parameters=tail_parameters, tail_chemical_parameters=tail_chemical_parameters, tail_gap_parameters=tail_gap_parameters,
                    vnc_parameters=vnc_parameters,vnc_chemical_parameters=vnc_chemical_parameters,vnc_gap_parameters=vnc_gap_parameters,
                    vncb_parameters=vncb_parameters, vncb_chemical_parameters=vncb_chemical_parameters,vncb_gap_parameters=vncb_gap_parameters,
