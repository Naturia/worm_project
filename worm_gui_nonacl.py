...
from Worm_nonacl import Worm_n
from WormNet_nonacl import WormNet_n
...
def run_gui():
    ...
    screen = pygame.display.set_mode((800 * 2, 800 * 2))  # 1800,1200
    ...
    while running:
        ...
        pygame.draw.circle(screen, (50, 0, 0), (xy_pos[0] * scale + shift[0], xy_pos[1] * scale + shift[1]),
                           r + 100 + 100)
...
class WormPlotter():
    ...
    def __init__(self, sampleinterval=0.01, timewindow=10., size=(1000, 600)):  # 1000,600
        # Data stuff
        ...
        print("state to plot",self.state_to_plot)
...
if __name__ == '__main__':
    ...
    worm = Worm_n(step_size=step_size, test=False, parameters=worm_body_parameters, shared_lists=queue,
                gui_parameters=(scale, shift), nacl_location=nacl_location, state_queue=state_queue)
    worm_net = WormNet_n(step_size=step_size * ms, worm_entity=worm, nacl_entity=nacl, touch_entity=touch_signal,
